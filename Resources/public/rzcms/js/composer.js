    ...
    PageComposer.prototype = {
        ...
        handleBlockCreated: function (event) {
            var content = this.renderTemplate('childBlock', {
                ...
                'edit_url':   this.getRouteUrl('block_edit',   { 'PAGE_ID': this.getPageId(), 'BLOCK_ID': event.blockId }),
        ...
        handleBlockCreateFormLoaded: function (event) {
            ...
            var $form         = $childBlock.find('form'),
                ...
                $formActions  = $form.find('.form-actions-ajax'),
                $nameFormControl,
                $parentFormControl,
                $positionFormControl;
            ...
            $formActions.each(function () {
                var $formAction   = $(this),
                    $cancelButton = $('button[data-dismiss="modal"]');
                    ...
                    drop: function (event, ui) {
                        ...
                        if (typeof droppedBlockId != 'undefined') {
                            ...
                            var $container     = $(this),
                                ...
                                pageId       = parseInt(ui.draggable.attr('data-page-id'), 10),
