    ...
    PageComposer.prototype = {
        ...
        updateChildCount: function (blockId, count) {
            ...
            if ($viewCount.length > 0) {
                $viewCount.find('.page-composer__container__child-count span.badge').text(count);
            }
        },
        ...
        handleBlockCreateFormLoaded: function (event) {
                ...
                var $childBlock = $(['<li class="page-composer__container__child">',
                        '<a class="page-composer__container__child__edit">',
                            '<h4 class="page-composer__container__child__name">',
                                '<div class="form-group rz-form-group"><input type="text" class="form-control page-composer__container__child__name__input"></div>',
                            '</h4>',
                        '</a>',
            ...
            $formActions.each(function () {
                var $formAction   = $(this),
                    $cancelButton = $('<span class="btn btn-warning"><i class="fa fa-times-circle"></i> <span class="hidden-xs hidden-sm">' + self.translate('cancel') + '</span> </span>');
        ...
        handleBlockEditFormLoaded: function (event) {
            ...
            $form.find('input').each(function () {
                ...
                if (self.isFormControlTypeByName(formControlName, 'name')) {
                    $nameFormControl = $formControl;
                    $title.html('<div class="form-group rz-form-group"><input type="text" class="form-control page-composer__container__child__name__input" value="' + $title.text() + '"></div>');
